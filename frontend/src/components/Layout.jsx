        ...
        >
          ...
          {estClient && (
            <>
              ...
              <NavLink to="/mon-projet/documents" className={lienClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  ...
                  >
                    ...
                    {lang === "fr" && (
                      <svg
                        ...
                        strokeWidth={2}
                        stroke="currentColor"
                        className="w-4 h-4 ml-auto text-[#63B23E]"
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
